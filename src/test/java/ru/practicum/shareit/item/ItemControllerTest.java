...
class ItemControllerTest {
    ...
    void itemUpdate_whenUpdateIsNotCorrect_thenStatusIsBad() throws Exception {
        ItemDtoRequest itemDto = new ItemDtoRequest(
                0,
                null,
                " огда берешь в руки инструмент, еще даже не работа€, становитс€ пон€тно, что от него ждать, " +
                        "если внешне сделан аккуратно, удобно и при€тно держать в руках, " +
                        "нет шума и посторонних звуков в корпусе, то и в работе про€вит себ€ хорошо. " +
                        "“ак и вышло, по работе мен€ устраивает модель - отлично ставлю по всем параметрам, не подводила дрель.",
                null,
                0
        );
        long itemId = 1L;
